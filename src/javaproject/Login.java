...
public class Login extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(userName.equals("") || u_type.equals("") || u_type.equals("Select your user type") || password.equals("")){
            JOptionPane.showMessageDialog(null, "Some fields remain empty", "Error - 101 : Empty field!!!", 2);
        }
        
        else{
            try {
                String selection_query = "SELECT * FROM register";
             
                pst = con.prepareStatement(selection_query);
                ResultSet rs;
                rs = pst.executeQuery(selection_query);
                    ...
                    while(rs.next()){
                        ...
                        if(u_type.equals("Admin") && userType.equals("Admin") && pass.equals(password) && userName.equals(u_name)){
                        ...
                        else if(u_type.equals("Student") && userType.equals("Student") && userName.equals(u_name) && pass.equals(password)){
                                JOptionPane.showMessageDialog(null, "You've logged in your account successfully!!!", "Confirmation Message", 1);
                        ...
                        else if((!u_type.equals("Student") && !userType.equals("Student") && !userName.equals(u_name) && !pass.equals(password)) || (!u_type.equals("Admin") && !userType.equals("Admin") && !userName.equals(u_name) && !pass.equals(password))){
